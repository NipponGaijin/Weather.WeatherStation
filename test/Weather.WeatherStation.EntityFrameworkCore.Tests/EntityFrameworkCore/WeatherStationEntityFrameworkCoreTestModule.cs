...
namespace Weather.WeatherStation.EntityFrameworkCore
{
    [DependsOn(
        ...
        typeof(WeatherStationTestBaseModule),
        typeof(AbpEntityFrameworkCoreSqliteModule)
        )]
    public class WeatherStationEntityFrameworkCoreTestModule : AbpModule
    {
        ...
        private static SqliteConnection CreateDatabaseAndGetConnection()
        {
            ...
            using (var context = new WeatherStationDbContext(options))
            {
