...
namespace Weather.WeatherStation.Migrations
{
    ...
    [Migration("20220105172043_Created_Db_Entities")]
    partial class Created_Db_Entities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Weather.WeatherStation.Devices.Device", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Weather.WeatherStation.Measures.Measure", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppMeasures", (string)null);
                });

            modelBuilder.Entity("Weather.WeatherStation.Sensors.Sensor", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Weather.WeatherStation.Measures.Measure", b =>
                {
                    b.HasOne("Weather.WeatherStation.Sensors.Sensor", "Sensor")
                        .WithMany()
            ...
            modelBuilder.Entity("Weather.WeatherStation.Sensors.Sensor", b =>
                {
                    b.HasOne("Weather.WeatherStation.Devices.Device", "Device")
                        .WithMany()
