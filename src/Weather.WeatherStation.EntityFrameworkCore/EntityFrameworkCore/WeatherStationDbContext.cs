...
namespace Weather.WeatherStation.EntityFrameworkCore
{
    ...
    public class WeatherStationDbContext : 
        AbpDbContext<WeatherStationDbContext>,
        IIdentityDbContext,
        ITenantManagementDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            //{
            //    b.ToTable(WeatherStationConsts.DbTablePrefix + "YourEntities", WeatherStationConsts.DbSchema);
